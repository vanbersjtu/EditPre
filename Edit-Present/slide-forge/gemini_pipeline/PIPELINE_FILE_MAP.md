...
- `apps/slide-api/`
  ...
  - Persists uploaded PDF, rendered PNG pages, SVG output, and PPTX output under `app_data/jobs/<jobId>/`
...
- `apps/slide-web/`
  ...
  - Uploads PDF, exposes image refill strategy selection, polls backend status, previews generated SVGs, downloads PPTX
- `README.md`
